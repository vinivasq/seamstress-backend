...
namespace Seamstress.Persistence.Migrations
{
    ...
    [Migration("20240901174823_DropSetIdFromItems")]
    partial class DropSetIdFromItems
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Seamstress.Domain.SetItem", b =>
                {
                    b.Property<int>("ItemId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Seamstress.Domain.Order", b =>
                {
                    ...
                    b.HasOne("Seamstress.Domain.Identity.User", "Executor")
                        .WithMany()
            ...
            modelBuilder.Entity("Seamstress.Domain.SetItem", b =>
                {
                    b.HasOne("Seamstress.Domain.Item", "Item")
                        .WithOne("SetItem")
                        .HasForeignKey("Seamstress.Domain.SetItem", "ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
